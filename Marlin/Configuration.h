...
#define STRING_CONFIG_H_AUTHOR "(aethio, Sidewinder X1 - SKR 1.4 Turbo)" // Who made the changes.
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 499.58 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 28, -34, -3.3 }
